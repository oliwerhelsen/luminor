...
final class CsrfToken
{
     ...
     */
    public static function getFromSession(\Luminor\Session\SessionInterface $session): ?string
    {
     ...
     */
    public static function storeInSession(\Luminor\Session\SessionInterface $session, string $token): void
    {
     ...
     */
    public static function regenerate(\Luminor\Session\SessionInterface $session): string
    {
        $token = self::generate();
